...
cart.addEventListener("click", () => {
  cartDiv.dataset.dropdown =
    cartDiv.dataset.dropdown === "active" ? "inactive" : "active";
});
...
addToCart.addEventListener("click", () => {
  let amountProduct = parseInt(amount.value) + parseInt(cartAmount);
  cartAmount = amountProduct;
  ...
  let price = parseInt(
    document
      .querySelector(".product-description .price-with-discount")
      .innerHTML.replace("$", "")
  );
